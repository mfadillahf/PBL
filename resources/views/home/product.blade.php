        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xs-12 product-description-wrap">
                ...
                <div class="product-actions">
                    ...
                    <input type="number" step="1" min="1" max="{{$product->stok}}" value="1" title="Qty" class="input-text jumlah qty text" />
                ...
                <div class="product_meta">
                    <span class="stok">Stock: <a href="#">{{$product->stok}}</a></span> <!-- Menampilkan stok produk -->
...
<script>
    $(function(){
        ...
        // Mencegah input langsung dari keyboard melebihi stok atau kurang dari 1
        ...
        $('.add-to-cart').click(function(e){
            ...
            var id_member = {{ Auth::guard('webmember')->check()? Auth::guard('webmember')->user()->id : 0 }};
