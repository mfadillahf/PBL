                            ...
                            <table class="table shop_table ecommerce-checkout-review-order-table">
                                <tbody>
                                    <tr class="order-total">
                                        ...
                                        <td>
                                            <strong><span class="amount" id="order_total">Rp.
...
<script>
    $(function(){
        ...
        // Set the nominal transfer input with the order total
        let orderTotal = '{{ $orders->grand_total }}';
        $('#nominal_transfer').val(orderTotal);
    });
</script>
@endpush
